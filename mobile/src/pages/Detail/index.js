...
export default function Detail() {
  ...
  const message =
    `Olá ${incident.name}, estou entrando em contato pois fostaria de ajudar` +
    `no caso "${incident.title}" com o valor de ${incident.value}`;
  ...
  function sendMail() {
    MailComposer.composeAsync({
      subject: `Sou o Herói do caso: ${incident.title}`,
